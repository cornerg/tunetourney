...
export default function TTAlertDialogue({
  title,
  description,
  buttonText,
  onConfirm,
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content
          ...
          <div className="column w-full gap-2">
            <AlertDialog.Title className="m-0 text-xl text-primary font-bold">
              {title}
            </AlertDialog.Title>
          ...
          <div className="row justify-end items-end gap-2">
            {showCancel && (
              <AlertDialog.Cancel asChild>
                <TTButton buttonStyle="outline" className="px-2 min-h-9">
                  Cancel
                </TTButton>
              </AlertDialog.Cancel>
            )}
            ...
            <AlertDialog.Action asChild>
              <TTButton className="px-2 min-h-9" onClick={onConfirm}>
                {buttonText}
              </TTButton>
            </AlertDialog.Action>
          </div>
