  ...
  return (
    <div className={cn("column w-full gap-0", className)} {...props}>
      <div className="row w-full items-center gap-0">
        <div className="w-full mr-[-8px] flex-1 h-3 rounded-l-lg bg-primary" onClick={() => setValue(1)} />
        ...
        <div className="w-full ml-[-8px] flex-1 h-3 rounded-r-lg bg-dark" onClick={() => setValue(10)} />
      </div>
      ...
      <div className="row w-full flex-nowrap">
        {VALUES.map((num) => {
          ...
          return (
            <div key={`value-${num}`} className="row w-full h-9 flex-1 justify-center" onClick={() => setValue(num)}>
              <p
                className={cn(
                  "w-9 text-center font-bold select-none",
                  {
                ...
                style={{ transition: "color 200ms ease-out, font-size 200ms ease-out, margin-top 200ms ease-out" }}
              >
                {num}
              </p>
            </div>
